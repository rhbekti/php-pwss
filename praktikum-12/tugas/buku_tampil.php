    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$dt['judul'];?></td>
                <td><?=$dt['pengarang'];?></td>
                <td> <a href="buku_detail.php?idbuku=<?=$dt['idbuku'];?>">Lihat Buku</a> | <a
                        href="buku_edit.php?idbuku=<?=$dt['idbuku']?>&edit=<?=sha1($dt['idbuku'])?>">Edit Buku</a> | <a
                        href="buku_hapus.php?idbuku=<?=$dt['idbuku']?>">Hapus Buku</a></td>
            </tr>
